...
public class CustomSound extends Sound
{
    ...
    public function playCustom(startTime:Number = 0,loops:int = 0,sndTransform:SoundTransform = null, removeCallback:Function=null):SoundChannel
    {
        _sound.play(startTime, loops, sndTransform);
        _removeCallback = removeCallback;
        setTimeout(remove, _sound.length);
        return _channel;
    }

    private function remove():void
    {
        if(_removeCallback) _removeCallback(_name, this);
    }
